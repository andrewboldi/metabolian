...
# 2-O-glutaroyl-1-O-palmitoyl-sn-glycero-3-phosphocholine(1−) to trans-4-carboxybut-2-enoyl-CoA(5−); everything entering or leaving at the
# side is a cofactor on that step. Generated by tools/ingest/build-modules.mjs —
# edit the generator, not this file.

pathway 2-o-glutaroyl-1-o-palmito-to-trans-4-carboxybut "2-O-glutaroyl-1-O-palmito… to trans-4-carboxybut-2-enoy…" {
  spacing 152

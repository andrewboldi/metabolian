...
# N-acetyl-β-D-galactosaminyl-(1→4)-[α-N-acetylneuraminyl-(2→3)]-β-D-galactosyl-(1→4)-β-D-glucosyl-(1↔1)-ceramide(1−) to D-galactopyranose; everything entering or leaving at the
# side is a cofactor on that step. Generated by tools/ingest/build-modules.mjs —
# edit the generator, not this file.

pathway n-acetyl-d-galactosamin-to-d-galactopyranose "N-acetyl-β-D-galactosamin… to D-galactopyranose" {
  spacing 152
  ...
  spine at 0,0 {
    ...
    <-> . +d_galactosyl_1_4_d_glucosyl_1_1_ceramide +udp_d_galactose -udp -hplus
